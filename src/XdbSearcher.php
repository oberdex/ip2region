...
class XdbSearcher
{
    ...
    {
        return new XdbSearcher(null, null);
    }
     ...
     * @throws \Exception
     */
    public static function newWithVectorIndex($vIndex)
    {
        return new XdbSearcher($vIndex);
    }
     ...
     * @throws \Exception
     */
    function __construct($vectorIndex = null, $cBuff = null)
    {
    ...
    public static function loadHeaderFromFile()
    {
        $handle = fopen(self::getDbFile(), 'r');
        if ($handle === false) {
            return null;
        }
     ...
     * @return string|null
     */
    public static function loadVectorIndexFromFile()
    {
        $handle = fopen(self::getDbFile(), 'r');
        if ($handle === false) {
            return null;
    ...
    {
        $str = file_get_contents(self::getDbFile(), false);
        if ($str === false) {
            return null;
        } else {
            return $str;
